...
export var Wheel = function (_a) {
    ...
    useEffect(function () {
        ...
        if (mustStartSpinning && !isCurrentlySpinning) {
            ...
            var finalRotationDegreesCalculated = getRotationDegrees(selectedPrize, getQuantity(prizeMap), isPrizeCentered);
